...
**Date**: 2026-05-26
**Status**: 🔶 PILOT IMPLEMENTED 2026-05-27 — HSK1 (20 level, L101-120) chạy được.
Exam đa ngôn ngữ theo `targetLang`; planets HSK1/2/3 (🐼🏮🧧); dùng lại ảnh English
(starter_lN + garden/farm/bedroom outline) → không cần gen ảnh mới. Part 2 nhận hanzi+pinyin.
CÒN LẠI: (1) audio tiếng Trung cần pipeline Qwen-TTS (worker hiện chỉ có TTS tiếng Anh →
audio ZH chưa hay); (2) HSK2/HSK3; (3) content đang template-driven, chưa hand-curated.
